...
## 공개 페이지에서 분리한 작성 기준
  ...
  자료와 작성 기준  과정명·기관·기간·시간은 ICT이노베이션스퀘어 공식 교육 안내, 사업 배경은 국립공주대학교 공식 게시물을 확인했습니다. 공식 모집 안내의 장소 표기는 “천안기술교육센터/국립공주대학교 천안캠퍼스”이며, 실제 진행 건물인 제1공학관과 외주 강의 수행 관계는 담당 강사 최수길의 현장 확인을 반영했습니다.  팀 구성은 교육생 공유 슬라이드, 프로젝트 내용은 각 팀의 계획서·기술서·개발 기록·공개 코드와 열람 가능한 발표자료를 기준으로 정리했습니다. 구현 결과는 제출 자료의 기록이며, 이 글 작성을 위해 로봇을 재실행한 결과는 아닙니다.  2조는 최종 통합 브랜치와 최종 기술서를 우선했고, 3조는 발표자료 안내 파일의 실제 연결 대상 슬라이드를 확인했습니다. 2조 발표자료는 제공된 PDF 18쪽으로 확인하고, 최종 기술서와 함께 대조했습니다. 4조는 제공받은 「4조_발표자료_공주대_하계프로젝트.pdf」 12쪽을 확인했으며, 최종 발표의 팀 구성과 역할을 우선했습니다. 팀별 발표 PDF와 로컬 시연영상·GIF에서 대표 장면을 추출해 실었습니다. 캡션에 발표 쪽수 또는 영상 시점을 표시했으며, 로봇 하드웨어를 재실행한 검증은 아닙니다.   교육생 공유 슬라이드  ↗
