# C++ 후반 수업, 자료 구조에서 동시성까지

2025.04.21 오후–04.25 · 고려대학교 세종캠퍼스 · 직접 강의한 후반 과정

## 04.21 오후 | 컨테이너와 반복자로 데이터를 다루기
...
## 04.23 오후–04.24 오전 | 메모리의 소유 관계와 이동을 구분하기
...
- [강사 수업 기록 · C++ 후반 과정](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/doc/cpp.md): 4월 21~25일 날짜별 진행 내용.
- [통합 예제 · 데이터 처리 클래스](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/stl/range_example/processor.hpp): 선언과 구현을 나누는 학습 구조.
- [파일 처리·캡슐화 예제](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/stl/ex17_sort_fstream2.cpp): 파일 데이터 처리와 클래스 구성.
- [단독 소유 스마트 포인터 예제](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/smartpoint/ex1_unique_ptr.cpp): unique_ptr 사용을 살펴보는 강사 코드.
- [스레드 실습 예제](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/smartpoint/ex13_thread.cpp): 여러 작업의 실행을 다룬 수업 예제.
- [모던 C++ 통합 예제](https://github.com/freshmea/kuBig2025/blob/856a133a87d232a8ec714687139644f01f0a6cb9/smartpoint/ex16_finalModernExample.cpp): 후반부 기능을 연결하는 데이터 관리 실습.

내부 대조: C++ 후반 강의계획서(2025.04.21), 주간 업무일지(2025.04.18·04.25). 교육생 식별 정보 미수록.

## 도해

- ![cpp-overview](../../assets/img/projects/ku-2025-visuals/cpp-overview.svg)
